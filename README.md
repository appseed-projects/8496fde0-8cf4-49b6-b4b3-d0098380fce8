...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-20 14:06`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8496fde0-8cf4-49b6-b4b3-d0098380fce8.git
$ cd 8496fde0-8cf4-49b6-b4b3-d0098380fce8
```
